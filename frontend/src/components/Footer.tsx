...
export function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-line bg-surface">
      <div className="mx-auto grid max-w-shell gap-8 px-4 py-10 md:grid-cols-[1.6fr_auto] md:px-8">
        <div className="max-w-xl space-y-3">
          <BrandMark />
          <p className="text-[16px] leading-relaxed text-ink-500 sm:text-[17px]">{t.productTagline}</p>
          <p className="text-[15px] leading-relaxed text-ink-500">{t.notOfficialService}</p>
        </div>
